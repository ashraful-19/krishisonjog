  ...
  .then(data => {
    ...
    setTimeout(() => {
      ...
      if (data.length === 0) {
        ...
        row.innerHTML = `
          <td colspan="8" style="text-align: center; font-size: 20px; padding:40px; margin-top:20px" ><img src="/images/logo.png" alt="Logo" style="width: 100px; height: auto;"><h3>কোন চাষি/ট্রাক/স্টোরেজ পাওয়া যায়নি।</h3>
<h4>রেজিস্ট্রেশন চলমান, আমাদের সাথেই থাকুন।</h4></td>
        `;
